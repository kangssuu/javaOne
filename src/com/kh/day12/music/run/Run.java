	...
	public static void main(String[] args) {
		...
		int index = 0;
			...
			case 4:
				...
				List<Music> searchList = mController.searchMusicsByName(title);  // 이름이 같은게 있을 수 있으니까 리스트에 넣기
			...
			case 6:
				...
				break;
			case 7: 
				view.printMessage("========= 곡 명 오름차순 정렬 ============");
				mController.bubbleSortByTitleASC();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해 주세요");
				break;
			case 8:
				view.printMessage("========= 곡 명 내림차순 정렬 ============");
				mController.bubbleSortByTitleDEST();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해 주세요");
				break;
			case 9:
			...
			case 10:
				...
				mController.bubbleSortBySingerDEST();
				view.displaySuccess("정렬 성공! 3번을 눌러 출력해 주세요");
				break;
			case 0:
